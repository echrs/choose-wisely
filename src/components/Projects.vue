  ...
  <v-main>
    ...
    <section v-show="hasMetaMask" id="projects">
      ...
      <v-container class="text-center">
        <h2 class="display-2 font-weight-bold mb-5">PROJEKTI</h2>
        <div></div>
        ...
        <v-responsive
          ...
          max-width="720"
        >
          Odaberite projekt koji vam se najviše sviđa i možda ćete upravo njega
          vidjeti u svom gradu. Projekt s najviše glasova pobjeđuje. Do sada je
          glasalo {{ this.totalVoteCount }} ljudi -- glasajte i vi.
        </v-responsive>
        ...
        >
          ...
          ><v-col>
            <v-card class="mx-auto" outlined max-width="444">
              ...
              <v-card-subtitle class="text-left font-weight-bold text-uppercase"
                >Broj glasova: {{ this.project1.voteCount }}</v-card-subtitle
              >
              ...
              <v-expand-transition>
                <div v-show="showProject1">
                  <v-divider></v-divider>
                  <v-card-text class="text-left">{{ this.project1.description }}</v-card-text>
                  <v-btn
                    class="font-weight-bold"
                    color="#0248bb"
                    text
          ...
          <v-col>
            <v-card class="mx-auto" outlined max-width="444">
              ...
              <v-card-subtitle class="text-left font-weight-bold text-uppercase"
                >Broj glasova: {{ this.project2.voteCount }}</v-card-subtitle
              >
              ...
              <v-expand-transition>
                <div v-show="showProject2">
                  <v-divider></v-divider>
                  <v-card-text class="text-left"> {{ this.project2.description }} </v-card-text>
                  <v-btn
                    class="font-weight-bold"
                    color="#0248bb"
                    text
          ...
          <v-col>
            <v-card class="mx-auto my-12" outlined max-width="444">
              ...
              <v-card-subtitle class="text-left font-weight-bold text-uppercase"
                >Broj glasova: {{ this.project3.voteCount }}</v-card-subtitle
              >
              ...
              <v-expand-transition>
                <div v-show="showProject3">
                  <v-divider></v-divider>
                  <v-card-text class="text-left"> {{ this.project3.description }} </v-card-text>
                  <v-btn
                    class="font-weight-bold"
                    color="#0248bb"
                    text
     ...
     <section v-show="!hasMetaMask" id="projects">
      ...
      <v-container class="text-center">
        <h2 class="font-weight-bold mb-5">Za korištenje aplikacije potreban je MetaMask.</h2>
        <div></div>
      </v-container>
